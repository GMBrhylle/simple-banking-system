class StringConstant:
    ...
    # Generate repetitive dashes and assign them to 'ELEMENT_01'
    dash_line = '-' * 38 + ''
    UI_ELEMENTS['ELEMENT_01'] = dash_line

    # Generate repetitive equals and assign them to 'ELEMENT_02'
    equals_line = '=' * 7
    UI_ELEMENTS['ELEMENT_02'] = equals_line
    ...
    HEADER = {
        'HEADER_01': f'\n{UI_ELEMENTS.get("ELEMENT_02")} displaying all clients {UI_ELEMENTS.get("ELEMENT_02")}',
        ...
        'HEADER_09': f'{UI_ELEMENTS.get("ELEMENT_02")} opening an account {UI_ELEMENTS.get("ELEMENT_02")}',
    ...
    FIELD_LABEL_PROMPTS = {
        ...
        'PROMPT_35': 'select "1" to create '.title() + 'your client id'.upper(),
    ...
    ERROR_MESSAGES = {
        ...
        'ERROR_05': 'Error: Please enter a number only.',
